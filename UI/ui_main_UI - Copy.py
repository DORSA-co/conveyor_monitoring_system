...
################################################################################
## Form generated from reading UI file 'main_UI - Copy.ui'
##
...
" }")
        icon3 = QIcon()
        icon3.addFile(u"../../trainApp_oxin/UI/images/icons/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon10 = QIcon()
        icon10.addFile(u"images_icon/stop-button.png", QSize(), QIcon.Normal, QIcon.Off)
        self.BTN_scane_stop.setIcon(icon10)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u"C:/Users/Dorsa-Admin/.designer/backup/Icons/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        self.setting_refresh_available_cams_btn.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u"C:/Users/Dorsa-Admin/.designer/backup/Icons/apply_params.png", QSize(), QIcon.Normal, QIcon.Off)
        self.BTN_camera_setting_apply.setIcon(icon12)
...
"}")
        ...
        icon13 = QIcon()
        icon13.addFile(u"images_icon/play-button.png", QSize(), QIcon.Normal, QIcon.Off)
        self.BTN_camera_connect.setIcon(icon13)
        ...
        self.BTN_camera_disconnect.setIcon(icon10)
...
"}")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 286, 315))
        ...
        self.BTN_algo_param_setting.setIcon(icon12)
...
"}")
        ...
        self.BTN_laser_detector_connect.setIcon(icon13)
        ...
        self.BTN_laser_detector_disconnect.setIcon(icon10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LBL_live_camera.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
