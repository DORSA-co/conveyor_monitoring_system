...
"}")
        ...
        self.defects_prev_btn_3 = QPushButton(self.frame_80)
        self.defects_prev_btn_3.setObjectName(u"defects_prev_btn_3")
        self.defects_prev_btn_3.setEnabled(True)
        self.defects_prev_btn_3.setMinimumSize(QSize(30, 30))
        self.defects_prev_btn_3.setMaximumSize(QSize(30, 30))
        self.defects_prev_btn_3.setCursor(QCursor(Qt.PointingHandCursor))
        self.defects_prev_btn_3.setStyleSheet(u"background-color:Transparent;\n"
"border:Transparent")
        icon11 = QIcon()
        icon11.addFile(u"images_icon/arrow-left.png", QSize(), QIcon.Normal, QIcon.Off)
        self.defects_prev_btn_3.setIcon(icon11)
        self.defects_prev_btn_3.setIconSize(QSize(30, 30))

        self.horizontalLayout_28.addWidget(self.defects_prev_btn_3)

        self.segment_list_slider_frame = QLabel(self.frame_80)
        self.segment_list_slider_frame.setObjectName(u"segment_list_slider_frame")
        self.segment_list_slider_frame.setFrameShape(QFrame.Panel)
        self.segment_list_slider_frame.setFrameShadow(QFrame.Sunken)

        self.horizontalLayout_28.addWidget(self.segment_list_slider_frame)

        self.defects_next_btn_3 = QPushButton(self.frame_80)
        self.defects_next_btn_3.setObjectName(u"defects_next_btn_3")
        self.defects_next_btn_3.setEnabled(True)
        self.defects_next_btn_3.setMinimumSize(QSize(30, 30))
        self.defects_next_btn_3.setMaximumSize(QSize(30, 30))
        self.defects_next_btn_3.setCursor(QCursor(Qt.PointingHandCursor))
        self.defects_next_btn_3.setStyleSheet(u"background-color:Transparent;\n"
"border:Transparent")
        icon12 = QIcon()
        icon12.addFile(u"images_icon/arrow-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.defects_next_btn_3.setIcon(icon12)
        self.defects_next_btn_3.setIconSize(QSize(30, 30))

        self.horizontalLayout_28.addWidget(self.defects_next_btn_3)
...
"}")
        ...
        icon18 = QIcon()
        icon18.addFile(u"C:/Users/Dorsa-Admin/.designer/backup/images_icon/refresh(1).png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 278, 459))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 593, 414))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.defects_prev_btn_3.setText("")
        self.segment_list_slider_frame.setText("")
        self.defects_next_btn_3.setText("")
