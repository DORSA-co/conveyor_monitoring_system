...
" }")
        icon3 = QIcon()
        icon3.addFile(u"icons/cil-action-redo.png", QSize(), QIcon.Normal, QIcon.Off)
...
" }")
        icon9 = QIcon()
        icon9.addFile(u"../../trainApp_oxin/UI/images/icons/person2.png", QSize(), QIcon.Normal, QIcon.Off)
        self.close_btn_2.setIcon(icon9)
...
"}")
        ...
        icon14 = QIcon()
        icon14.addFile(u"images_icon/stop-button.png", QSize(), QIcon.Normal, QIcon.Off)
        self.BTN_camera_disconnect.setIcon(icon14)
...
"}")
        ...
        self.BTN_laser_detector_disconnect.setIcon(icon14)
