...
class Camera:
    ...
    def set_image_event(self, func):
        ...
        self.camera_device.RegisterImageEventHandler(
            self.image_event_handler,
...
class CameraStatus:
    ...
    def is_trigger_on(
        ...
        return (
            self.camera_object.Parms.__get_value__(
                self.camera_object.camera_device.TriggerMode
            ).lower()
            == "on"
        )
...
class CameraParms:
        ...
        if value is not None:
            if type(value) == int or type(value) == float:
                ...
                if value not in self.__get_available_value__(parameter):
                    print(
                        ErrorAndWarnings.value_not_available(
                            parameter.Node.Name, self.__get_available_value__(parameter)
                        )
                    )
                    return
    ...
    def set_exposureTime(self, exposure: int) -> None:
        ...
        if self.camera_object.Infos.is_PRO():
            ...
            self.__set_value__(
                exposure, self.camera_object.camera_device.ExposureTimeAbs
            )
    ...
    def set_trigger_option(
        self, source: str, selector=Trigger.selector.frame_start
    ) -> None:
    ...
    def availble_triggersource_values(self) -> tuple[str]:
        ...
        """
        return self.__get_available_value__(
            self.camera_object.camera_device.TriggerSource
        )
    ...
    def availble_triggerselector_values(self) -> tuple[str]:
        ...
        """
        return self.__get_available_value__(
            self.camera_object.camera_device.TriggerSelector
        )
    ...
    def set_transportlayer(self, packet_delay: int, packet_size=None) -> None:
        ...
        """
        self.__set_value__(
            packet_size, self.camera_object.camera_device.GevSCPSPacketSize
        )
