...
class moveOnList:
    ...
    def build_prev_func(self, name):
        def prev_on_list():
            ...
            if DEBUG:
                print("8" * 50, self.idxs[name], len(self.lists[name]))
    ...
    def next_on_list(self, name):
        ...
        if DEBUG:
            print("7" * 10, self.idxs[name], len(self.lists[name]))
...
class moveOnImagrList:
    def __init__(self, sub_directory="", step=6):
    ...
    def append_mylist(self, item, name):
    ...
    def build_next_func(self, name):
        ...
        def next_on_list():
            ...
            if DEBUG:
                print("9" * 50, self.idxs[name], len(self.lists[name]))
